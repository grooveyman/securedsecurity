...
public class SuspectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPullRefresh = SuspectsView.findViewById(R.id.pull_to_refresh);
        LinearLayoutManager suspectLayout = new LinearLayoutManager(getContext());
        suspectLayout.setReverseLayout(true);
        suspectLayout.setStackFromEnd(true);
        mySuspectList.setLayoutManager(suspectLayout);
...
//
                ...
                LayoutAnimationController animationController = AnimationUtils.loadLayoutAnimation(getContext(),R.anim.layout_anim);
...
//
        ...
        adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onItemRangeInserted(int positionStart, int itemCount) {
               mySuspectList.smoothScrollToPosition(positionStart);
            }
        });
        mySuspectList.setAdapter(adapter);
        LayoutAnimationController animationController = AnimationUtils.loadLayoutAnimation(getContext(),R.anim.layout_anim);
